...
\textsc{Olinga Taeed}\thanks{} \\[1ex] % Second author's
% name
...
The majority of judgements are currently centralized on the figure of a judge
with a supposedly high enough general consciousness about the society and its
dynamics to perform fair resolutions.
...
That means the consciouness level has to be about the subject being judged\cite{DanielDAGS2016}.
...
by some researchers even more disrupting than the internet itself.
Both decentralization and the blockchain trends are powered by the scale economy.

The purpose of this paper is to evaluate how these novel concepts can be applied
to the judgement process\cite{AntonopoulosDAMN2016} and propose the development
of a fairer justice system that provides resolutions for the legal needs of
the community regardless of individual's economic or social means\cite{nla.cat-vn632475}.
%------------------------------------------------
